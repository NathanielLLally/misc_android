...
while [ \( $(($limit-$n)) -gt 0 \) -o \( $limit -eq 0 \) ]; do
  adb shell input swipe 751 621 751 621 1061
  sleep 0.7
  adb shell input swipe 997 635 997 635 211
  sleep 1
  adb shell input swipe 326 963 326 963 161
  sleep 1
  adb shell input swipe 1606 1067 1606 1067 250
  sleep 47
  n+=1
