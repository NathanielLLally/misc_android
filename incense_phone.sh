...
while [ \( $(($limit-$n)) -gt 0 \) -o \( $limit -eq 0 \) ]; do
   adb shell input swipe 946 585 946 585 1064
  sleep 1
  adb shell input swipe 1298 611 1298 611 191
  sleep 1
  adb shell input swipe 1941 373 1941 373 99
  sleep 1
  adb shell input swipe 1917 956 1917 956 123
  sleep 96
  n+=1
