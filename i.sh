...
while [ \( $(($limit-$n)) -gt 0 \) -o \( $limit -eq 0 \) ]; do
  adb shell input swipe 688 578 688 578 144
  sleep 2
  adb shell input swipe 1751 194 1751 194 175
  sleep 2
  adb shell input swipe 337 824 337 824 175
  sleep 2
  adb shell input swipe 1661 1061 1661 1061 197
  sleep 14
  n+=1
  while [ $(($n%27)) -ne 0 ]; do
    adb shell input swipe 673 615 673 615 868
    sleep 1.5
    adb shell input swipe 1167 635 1167 635 127
    sleep 1.5
    adb shell input swipe 334 841 334 841 158
    sleep 1.5
    adb shell input swipe 1591 1063 1591 1063 158
    sleep 14.5
    n+=1
    echo "$n"
  done
