...
while [ \( $(($limit-$n)) -gt 0 \) -o \( $limit -eq 0 \) ]; do
  adb shell input swipe 972 805 972 805 995
  sleep 0.6
  adb shell input swipe 1202 796 1202 796 93
  sleep 1
  adb shell input swipe 640 1320 640 1320 45
  sleep 1
  adb shell input swipe 2105 1457 2105 1457 99
  sleep 46
  n+=1
